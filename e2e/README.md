...
- **response-jailbreak**: response-direction jailbreak signal and response_jailbreak plugin coverage for LLM output carrying jailbreak content past the classifier's sequence window, a response-stage decision composed with a request signal, and the streamed-response pass-through contract.
