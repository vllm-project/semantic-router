...
func TestRequiredPermission(t *testing.T) {
	...
	testCases := []struct {
		...
		{method: http.MethodGet, path: "/api/model-research/recipes", expected: PermMlPipeline},
		{method: http.MethodPost, path: "/api/model-research/campaigns", expected: PermMlPipeline},
	}
