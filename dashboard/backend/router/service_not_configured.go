...
func notConfiguredServiceHandler(serviceName, envVar, exampleValue string) http.HandlerFunc {
...
func staticJSONHandler(payload string) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		writeJSONResponse(w, http.StatusOK, payload)
	}
}

func jsonErrorHandler(status int, payload string) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		writeJSONResponse(w, status, payload)
	}
}

func withCORSPreflight(next http.Handler) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func writeJSONResponse(w http.ResponseWriter, status int, payload string) {
