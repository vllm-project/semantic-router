...
func builtinSuites() []CatalogSuite {
	return []CatalogSuite{
		...
		{ID: "router-learning-core", Name: "Router Learning policy comparison", Description: "Replays 32 seeded trials comparing static/base routing, full production routing_sampling scoring, and Beta-Bernoulli. Uses synthetic outcomes for diagnostic comparisons; does not measure live production performance.", Executors: map[Mode]string{ModeReplay: routerLearningReplayExecutorID}, TrackIDs: []TrackID{"joint"}, Modes: []Mode{ModeReplay}, EvidenceLevel: "E0", CaseCount: 12, Revision: "router-learning-core-v2", Tags: []string{"router-learning", "paired-seeds", "deterministic", "diagnostic-only"}, Methods: []CatalogMethod{
