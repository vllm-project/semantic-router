...
- Browser components must not execute Agent tools or persist long-horizon session authority. Agent turns, tools, checkpoints, and publication plans belong to the Router Management contract.
