...
import type { ModelConfig } from './configPageSupport'
...
export default function ConfigPageSafetyCacheSection({
  ...
  const bertModel = routerConfig.bert_model
      ...
      <div className={styles.sectionContent}>
          ...
          <div className={styles.modelCard}>
            <div className={styles.modelCardHeader}>
              ...
              <span className={`${styles.statusBadge} ${styles.statusActive}`}>
	                {bertModel.use_cpu ? 'CPU' : 'GPU'}
              </span>
            </div>
            <div className={styles.modelCardBody}>
              <div className={styles.configRow}>
                <span className={styles.configLabel}>Model ID</span>
	                <span className={styles.configValue}>{bertModel.model_id}</span>
              </div>
              <div className={styles.configRow}>
                <span className={styles.configLabel}>Threshold</span>
	                <span className={styles.configValue}>{formatThreshold(bertModel.threshold)}</span>
              </div>
            </div>
          </div>
        ) : (
