    ...
    <div className={styles.dashboard}>
      <div className={styles.dashboardHeader}>
        <div className={styles.dashboardHeading}>
          ...
          <p>Shape one reusable routing Recipe.</p>
        </div>
        <div
        ...
        <section className={`${styles.dashSection} ${styles.routeSection}`}>
          <div className={styles.dashSectionHeading}>
            <div>
              ...
              <p>How each request selects a decision.</p>
            </div>
            ...
            <div className={styles.routeMapFlow}>
              ...
              {routes.length === 0 ? (
                <div className={styles.routeMapEmpty}>
                  ...
                  <span>Add a decision to complete this Recipe.</span>
                </div>
              ) : null}
            </div>
          </div>
            ...
            <section className={styles.dashSection}>
              <div className={styles.dashSectionHeading}>
                <div>
                  ...
                  <p>Add one clear building block.</p>
                </div>
              </div>
              <div className={styles.quickActions}>
                {(['signal', 'route', 'plugin'] as EntityKind[]).map((kind) => (
                  <button
                    key={kind}
                    type="button"
