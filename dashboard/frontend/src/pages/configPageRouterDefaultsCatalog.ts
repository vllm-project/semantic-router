...
export const OPTIONAL_ROUTER_KEYS: RouterSystemKey[] = ['bert_model']
...
export const SECTION_META: Record<RouterSystemKey, { title: string; eyebrow: string; description: string }> = {
  ...
  bert_model: {
    title: 'Legacy BERT Similarity',
    eyebrow: 'Legacy',
    description: 'Legacy semantic-similarity BERT settings retained for non-template compatibility.',
  },
}
