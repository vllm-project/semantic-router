import type {
  CatalogProtocol,
  CatalogProtocolOperation,
  CatalogProvider,
} from '../types/modelCatalog'

export interface EffectiveProviderOperation extends CatalogProtocolOperation {
  reference: string
}

const trimTrailingSlashes = (value: string): string => value.replace(/\/+$/, '')

const providerBasePath = (provider: CatalogProvider): string => {
