...
#   MILVUS_MODE=standalone RECREATE_CLUSTER=false CLEANUP=false ./tools/test/smoke/milvus/test-milvus-deployment.sh
#
#   # Non-interactive cluster deployment with cleanup
#   MILVUS_MODE=cluster RECREATE_CLUSTER=true CLEANUP=true ./tools/test/smoke/milvus/test-milvus-deployment.sh
