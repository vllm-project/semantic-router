...
#
# Prerequisites (provision a trusted authorization stack before running):
...
#
# Usage:
#   ./tools/test/smoke/test-authz-rbac.sh
#   ENVOY_PORT=9090 ./tools/test/smoke/test-authz-rbac.sh
#
set -euo pipefail
