...
- `config/` owns canonical router configuration, reusable fragments, complete
  use-case recipes, and backend runtime examples.
- `deploy/` owns only artifacts that create or configure a deployment target:
  Helm, Kubernetes, KServe, OpenShift, the operator, and local proxy manifests.
- `website/` is the sole public documentation tree.
- `tools/` owns build automation, developer utilities, smoke tests, model
  helpers, auxiliary test services, and this internal agent harness.
...
- Container adapter barrel and image/service helpers: [src/vllm-sr/cli/container_cli.py](../../../src/vllm-sr/cli/container_cli.py)
...
- [tools/agent/docs/README.md](README.md)
- [AGENTS.md](../../../AGENTS.md)
- [tools/agent/docs/governance.md](governance.md)
- [tools/agent/docs/tech-debt-register.md](tech-debt-register.md)
- [tools/agent/docs/tech-debt/README.md](tech-debt/README.md)
- [tools/agent/docs/change-surfaces.md](change-surfaces.md)
- [tools/agent/docs/environments.md](environments.md)
