...
Both live under `tools/agent/docs/` and have matching entries in
[`environments.md`](environments.md).

[`website/docs/installation/amd-rocm.md`](../../../website/docs/installation/amd-rocm.md) is a different
...
routing recipe (e.g. [`config/recipes/balance/config.yaml`](../../../config/recipes/balance/config.yaml)
