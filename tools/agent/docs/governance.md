...
- Put durable prose guidance in `tools/agent/docs/*`.
...
- Keep technical debt discoverable through the landing page and the indexed `tools/agent/docs/tech-debt/*.md` entry files.
