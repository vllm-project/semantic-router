...
If the desired architecture and the current implementation still diverge after your change, record the durable gap in [docs/agent/tech-debt-register.md](docs/agent/tech-debt-register.md) and its indexed detail file under [docs/agent/tech-debt/README.md](docs/agent/tech-debt/README.md).
