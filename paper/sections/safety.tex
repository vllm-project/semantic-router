...
\Cref{fig:safety_architecture} illustrates how safety signals integrate with domain signals and decision rules.
...
\noindent\textbf{Per-rule sensitivity.}
...
\noindent\textbf{Knowledge base construction.}
...
\noindent\textbf{Contrastive scoring.}
...
\noindent\textbf{Max-contrastive chain (multi-turn detection).}
...
\noindent\textbf{Integration with signal architecture.}
...
\noindent\textbf{Context-aware thresholds.}
...
\noindent\textbf{Per-domain PII policies.}
