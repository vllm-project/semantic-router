...
If a real architecture or code/spec gap remains after your change, add or update the durable item in [docs/agent/tech-debt-register.md](docs/agent/tech-debt-register.md) and its indexed detail file under [docs/agent/tech-debt/README.md](docs/agent/tech-debt/README.md).
