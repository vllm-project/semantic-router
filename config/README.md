...
- `global.router.model_selection.model_switch_gate` enables optional shadow or enforce-mode session-aware stay-vs-switch auditing after the configured selector runs
