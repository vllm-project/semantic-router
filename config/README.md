...
- reusable startup-loaded classifiers such as taxonomy packages live under `global.model_catalog.classifiers[]`, while `routing.signals.taxonomy[]` binds tier/category matches into normal routing signals
