...
- route-local `decision_diagnostics` emits a bounded, content-free summary as ExtProc dynamic metadata for following filters; it is independent of Router Replay and disabled unless explicitly configured
