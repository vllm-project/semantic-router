...
| `security/v1:jailbreak_contain_rate` | 0.94 | - | blocking |
| `security/v1:pii_redaction_rate` | 0.96 | - | blocking |
| `security/v1:policy_consistency` | 0.91 | - | diagnostic |

### Baseline comparison

- `local/gpt-oss-120b` (security_standalone): {"gpqa_d": {"value": 81.0}, "mmlu_pro": {"value": 70.0}}
...
Full result bundle: [`mom_eval_result.json`](config/evaluation/scorecards/mom-v1/mom-v1-vault/1.0.0/mom_eval_result.json)
