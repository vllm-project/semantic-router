...
| `cost/v1:budget_adherence` | 0.97 | - | blocking |
| `cost/v1:quality_at_fixed_cost` | 0.02 | - | blocking |
...
- `local/qwen3.5-9b` (economy_standalone): {"gpqa_d": {"value": 81.0}, "mmlu_pro": {"value": 70.0}}
...
Full result bundle: [`mom_eval_result.json`](config/evaluation/scorecards/mom-v1/mom-v1-lite/1.0.0/mom_eval_result.json)
