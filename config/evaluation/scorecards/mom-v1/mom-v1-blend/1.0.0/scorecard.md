...
- `local/qwen3.6-35b` (balanced_standalone): {"gpqa_d": {"value": 81.0}, "mmlu_pro": {"value": 70.0}}
...
Full result bundle: [`mom_eval_result.json`](config/evaluation/scorecards/mom-v1/mom-v1-blend/1.0.0/mom_eval_result.json)
