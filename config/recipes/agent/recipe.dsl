...
MODEL openai/gpt5.4 {
  capabilities: ["chat", "frontier_reasoning", "planning", "synthesis", "text"]
}
...
ENTRYPOINT {
  ...
  recipe: "default"
  assignments: [
    { decision: "complex_general", models: [{ model: "google/gemini-3.1-pro", weight: "1" }, { model: "openai/gpt5.4", weight: "1" }] },
    { decision: "domain_business", models: [{ model: "google/gemini-2.5-flash-lite", weight: "1" }] },
    { decision: "domain_code", models: [{ model: "google/gemini-2.5-flash-lite", weight: "1" }, { model: "google/gemini-3.1-pro", weight: "1" }] },
    { decision: "domain_code_complex", models: [{ model: "google/gemini-3.1-pro", weight: "1" }, { model: "openai/gpt5.4", weight: "1" }] },
    { decision: "domain_legal_health", models: [{ model: "anthropic/claude-opus-4.6", weight: "1" }] },
    { decision: "domain_stem_research", models: [{ model: "google/gemini-3.1-pro", weight: "1" }, { model: "openai/gpt5.4", weight: "1" }] },
