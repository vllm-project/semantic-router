...
ENTRYPOINT {
  ...
  recipe: "default"
  assignments: [
    { decision: "casual_chat", models: [{ model: "qwen/qwen3.5-rocm", weight: "1" }, { model: "google/gemini-2.5-flash-lite", weight: "1" }] },
    { decision: "complex_specialist", models: [{ model: "google/gemini-3.1-pro", weight: "1" }, { model: "openai/gpt5.4", weight: "1" }] },
    { decision: "fast_qa", models: [{ model: "qwen/qwen3.5-rocm", weight: "1" }, { model: "google/gemini-2.5-flash-lite", weight: "1" }] },
    { decision: "feedback_need_clarification", models: [{ model: "qwen/qwen3.5-rocm", weight: "1" }, { model: "google/gemini-2.5-flash-lite", weight: "1" }] },
    { decision: "feedback_wrong_answer_verified", models: [{ model: "google/gemini-2.5-flash-lite", weight: "1" }, { model: "google/gemini-3.1-pro", weight: "1" }] },
    { decision: "formal_math_proof", models: [{ model: "openai/gpt5.4", weight: "1" }, { model: "anthropic/claude-opus-4.6", weight: "1" }] },
    ...
    { decision: "verified_explainer", models: [{ model: "google/gemini-2.5-flash-lite", weight: "1" }, { model: "google/gemini-3.1-pro", weight: "1" }] },
    { decision: "verified_health", models: [{ model: "google/gemini-3.1-pro", weight: "1" }, { model: "anthropic/claude-opus-4.6", weight: "1" }] },
  ]
}
