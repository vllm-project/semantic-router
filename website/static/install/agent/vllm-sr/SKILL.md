...
5. Size the Router's signal models and generation backends separately, including
   ...
   live model inventory. See [deployment details](https://vllm-sr.ai/install/agent/vllm-sr/references/deployment-loop.md).
...
4. **Existing stack:** locally validate, then plan the exact mutation against
   ...
   [configuration details](https://vllm-sr.ai/install/agent/vllm-sr/references/configuration-loop.md).
...
the [repeated API and UI checks](https://vllm-sr.ai/install/agent/vllm-sr/references/evaluation-loop.md#repeated-api-and-ui-checks)
...
[deployment details](https://vllm-sr.ai/install/agent/vllm-sr/references/deployment-loop.md#dashboard-access).
