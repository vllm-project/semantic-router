...
AMD is a long-term technology partner for the **vLLM** community: from accelerating the **vLLM engine** on AMD GPUs to now exploring the next layer of the stack with **vLLM Semantic Router (VSR)**.
