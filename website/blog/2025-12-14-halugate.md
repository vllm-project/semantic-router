...
description: "How HaluGate adds token-level hallucination detection to vLLM Semantic Router by verifying assistant claims against tool outputs and grounding context in real time without LLM-as-judge overhead."
authors:
  - name: "vLLM Semantic Router Team"
    url: "https://github.com/vllm-project/semantic-router"
tags: ["ecosystem"]
image: "/img/blog/vllm/semantic-router/halugate-0.png"
source_url: "https://github.com/vllm-project/vllm-project.github.io/blob/main/_posts/2025-12-14-halugate.md"
---
...
Building on our [Signal-Decision Architecture](/blog/signal-decision), we introduce **HaluGate**—a conditional, token-level hallucination detection pipeline that catches unsupported claims *before* they reach your users. No LLM-as-judge. No Python runtime. Just fast, explainable verification at the point of delivery.
...
![Token-Level Truth: Real-Time Hallucination Detection for Production LLMs: Halugate 0](/img/blog/vllm/semantic-router/halugate-0.png)
...
![Token-Level Truth: Real-Time Hallucination Detection for Production LLMs: Halugate 1](/img/blog/vllm/semantic-router/halugate-1.png)
...
![Token-Level Truth: Real-Time Hallucination Detection for Production LLMs: Halugate 2](/img/blog/vllm/semantic-router/halugate-2.png)
...
![Token-Level Truth: Real-Time Hallucination Detection for Production LLMs: Halugate 3](/img/blog/vllm/semantic-router/halugate-3.png)
...
![Token-Level Truth: Real-Time Hallucination Detection for Production LLMs: Halugate 4](/img/blog/vllm/semantic-router/halugate-4.png)
...
HaluGate doesn't operate in isolation—it's deeply integrated with our [Signal-Decision Architecture](/blog/signal-decision) as a new signal type and plugin.
...
![Token-Level Truth: Real-Time Hallucination Detection for Production LLMs: Halugate 5](/img/blog/vllm/semantic-router/halugate-5.png)
...
![Token-Level Truth: Real-Time Hallucination Detection for Production LLMs: Halugate 6](/img/blog/vllm/semantic-router/halugate-6.png)
...
![Token-Level Truth: Real-Time Hallucination Detection for Production LLMs: Halugate 7](/img/blog/vllm/semantic-router/halugate-7.png)
...
![Token-Level Truth: Real-Time Hallucination Detection for Production LLMs: Halugate 8](/img/blog/vllm/semantic-router/halugate-8.png)
...
![Token-Level Truth: Real-Time Hallucination Detection for Production LLMs: Halugate 9](/img/blog/vllm/semantic-router/halugate-9.png)
...
![Token-Level Truth: Real-Time Hallucination Detection for Production LLMs: Halugate 10](/img/blog/vllm/semantic-router/halugate-10.png)
