...
description: Introducing HaluGate, a token-level hallucination detection pipeline for production LLMs that intercepts unsupported claims before delivery.
authors: [Xunzhuo, rootfs]
tags: [hallucination, halugate, safety, vllm, semantic-router]
image: /img/halugate-0.png
---
