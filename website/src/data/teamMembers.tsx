...
export const steeringCommitteeMembers: TeamMember[] = [
  ...
  },
  {
    ...
    bio: <Translate id="team.members.FAUST-BENCHOU.bio">Cloud-native contributor working on Kubernetes orchestration and LLM serving across Karmada, Volcano, and Kthena. LFX mentor for Kthena.</Translate>,
    memberType: 'maintainer',
  },
  {
    name: 'Bowei He',
...
export const topNewContributorMembers: TeamMember[] = [
  {
    name: 'Guan-Ming Chiu',
    role: <Translate id="team.members.guan404ming.role">Software Engineering Intern</Translate>,
    company: 'Quid',
    avatar: 'https://github.com/guan404ming.png',
    github: 'https://github.com/guan404ming',
    linkedin: 'https://www.linkedin.com/in/guanmingchiu',
    externalLinks: [
      { label: 'Website', href: 'https://guan404ming.com/' },
    ],
    bio: <Translate id="team.members.guan404ming.bio">Software engineering intern at Quid and graduate student at National Taiwan University, focused on machine learning systems. An Apache Airflow and Apache TVM Committer and PyTorch Collaborator.</Translate>,
    memberType: 'committer',
  },
  {
    name: 'Abhinav Mahajan',
    role: <Translate id="team.members.abhinav-m22.role">Software Engineer</Translate>,
    company: 'Barclays',
    ...
    bio: <Translate id="team.members.abhinav-m22.bio">Software engineer at Barclays building reliable backend services. Contributes to open-source infrastructure for LLMs and AI agents, with a focus on system design and production reliability.</Translate>,
    memberType: 'committer',
  },
  {
    name: 'Park Soobin',
    role: <Translate id="team.members.subin9.role">Forward Deployed Engineer</Translate>,
    company: 'Rebellions',
    avatar: 'https://github.com/subin9.png',
    github: 'https://github.com/subin9',
    linkedin: 'https://linkedin.com/in/soobinpark1',
    bio: <Translate id="team.members.subin9.bio">Forward Deployed Engineer at Rebellions, combining machine learning engineering and solution architecture to bring LLM inference to NPUs.</Translate>,
    memberType: 'committer',
  },
  {
    name: 'Anup Sharma',
    role: <Translate id="team.members.TwilightTechie.role">Member of Technical Staff</Translate>,
    company: 'Nutanix',
    avatar: 'https://github.com/TwilightTechie.png',
    github: 'https://github.com/TwilightTechie',
    linkedin: 'https://www.linkedin.com/in/anup-sharma1/',
    externalLinks: [
      { label: 'Website', href: 'https://twilighttechie.github.io/' },
    ],
    bio: <Translate id="team.members.TwilightTechie.bio">Software engineer working on distributed storage at Nutanix, with interests in LLM inference, model serving, and intelligent request routing.</Translate>,
    memberType: 'committer',
  },
  {
    name: 'Alex Jia',
    role: <Translate id="team.members.yaojiejia.role">Software & Data Engineer</Translate>,
    avatar: 'https://github.com/yaojiejia.png',
    github: 'https://github.com/yaojiejia',
    linkedin: 'https://www.linkedin.com/in/alex-jia-yaojie/',
    externalLinks: [
      { label: 'Website', href: 'https://www.alexjiaa.com/' },
    ],
    bio: <Translate id="team.members.yaojiejia.bio">Software and data engineer studying at NYU, focused on scalable systems and data pipelines. Contributes to Apache Hudi and has worked on SQLancer through Google Summer of Code.</Translate>,
    memberType: 'committer',
  },
  {
    name: 'Ádám Kovács',
    role: <Translate id="team.members.adaamko.role">Co-founder & CTO</Translate>,
    company: 'KR Labs',
    avatar: 'https://github.com/adaamko.png',
    github: 'https://github.com/adaamko',
    linkedin: 'https://www.linkedin.com/in/adaamko/',
    bio: <Translate id="team.members.adaamko.bio">Co-founder and CTO of KR Labs, working on open-source NLP tools for transparent and trustworthy AI. His experience spans academic research and production NLP systems.</Translate>,
    memberType: 'committer',
  },
  {
    name: 'David Shrader',
