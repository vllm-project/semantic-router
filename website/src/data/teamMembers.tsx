...
export const topNewContributorMembers: TeamMember[] = [
  {
    name: 'Guan-Ming Chiu',
    role: <Translate id="team.members.guan404ming.role">Open Source Contributor</Translate>,
    avatar: 'https://github.com/guan404ming.png',
    github: 'https://github.com/guan404ming',
    bio: <Translate id="team.members.guan404ming.bio">Open-source contributor to vLLM Semantic Router.</Translate>,
    memberType: 'committer',
  },
  {
    name: 'Abhinav Mahajan',
    role: <Translate id="team.members.abhinav-m22.role">Open Source Contributor</Translate>,
    avatar: 'https://github.com/abhinav-m22.png',
    github: 'https://github.com/abhinav-m22',
    bio: <Translate id="team.members.abhinav-m22.bio">Open-source contributor to vLLM Semantic Router.</Translate>,
    memberType: 'committer',
  },
  {
    name: 'Park Soobin',
    role: <Translate id="team.members.subin9.role">Open Source Contributor</Translate>,
    avatar: 'https://github.com/subin9.png',
    github: 'https://github.com/subin9',
    bio: <Translate id="team.members.subin9.bio">Open-source contributor to vLLM Semantic Router.</Translate>,
    memberType: 'committer',
  },
  {
    name: 'Anup Sharma',
    role: <Translate id="team.members.TwilightTechie.role">Open Source Contributor</Translate>,
    avatar: 'https://github.com/TwilightTechie.png',
    github: 'https://github.com/TwilightTechie',
    bio: <Translate id="team.members.TwilightTechie.bio">Open-source contributor to vLLM Semantic Router.</Translate>,
    memberType: 'committer',
  },
  {
    name: 'yaojiejia',
    role: <Translate id="team.members.yaojiejia.role">Open Source Contributor</Translate>,
    avatar: 'https://github.com/yaojiejia.png',
    github: 'https://github.com/yaojiejia',
    bio: <Translate id="team.members.yaojiejia.bio">Open-source contributor to vLLM Semantic Router.</Translate>,
    memberType: 'committer',
  },
  {
    name: 'Ádám Kovács',
    role: <Translate id="team.members.adaamko.role">Open Source Contributor</Translate>,
    avatar: 'https://github.com/adaamko.png',
    github: 'https://github.com/adaamko',
    bio: <Translate id="team.members.adaamko.bio">Open-source contributor to vLLM Semantic Router.</Translate>,
    memberType: 'committer',
  },
  {
    name: 'David Shrader',
