...
The detailed background is in [Unified Config Contract v0.3](../proposals/unified-config-contract-v0-3.md). This page is the practical guide for using the contract.
...
See [Kubernetes Operator](./k8s/operator.md).
