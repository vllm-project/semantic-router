...
![Your app sends a SystemOne or batch request to the Decision Runtime API. The API checks the request, a resident model scores the questions, and the answers return to your app.](/img/decision-runtime-flow.svg)
