...
- route-local `decision_diagnostics` is an independent, opt-in observability surface for bounded request-local ExtProc metadata; it does not persist bodies or require a replay store
