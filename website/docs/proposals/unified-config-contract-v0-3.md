...
- `global.services.observability.backend_telemetry` is the opt-in backend metrics collection switch for engine-aware adapters; it defaults to disabled and consumes those backend identity hints
