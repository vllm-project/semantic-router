...
and can create delegated Playground sessions, but cannot create, rotate, reassign, or
delete a key or alter its access/rate bindings. An invitation may materialize the
