...
GMTRouter uses a heterogeneous graph neural network (GNN) to learn personalized routing decisions based on user-model-query interactions.

Based on the [Personalized LLM Routing paper](https://arxiv.org/abs/2406.18665) - Learning User Preferences for Model Selection.
...
flowchart TD
    ...
    E --> F[Compute User-Model<br/>Attention Scores]
