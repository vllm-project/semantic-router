...
- **Elo**: [RouteLLM: Learning to Route LLMs with Preference Data](https://arxiv.org/abs/2406.18665) (ICLR 2025)
- **RouterDC**: [Query-Based Router by Dual Contrastive Learning](https://arxiv.org/abs/2409.19886) (NeurIPS 2024)
- **AutoMix**: [Automatically Mixing Language Models](https://arxiv.org/abs/2310.12963) (NeurIPS 2024)
- **Hybrid**: [Cost-Efficient Quality-Aware Query Routing](https://arxiv.org/abs/2404.14618)

### RL-Driven Algorithms

- **GMTRouter**: [Personalized LLM Routing via Graph Neural Networks](https://arxiv.org/abs/2511.08590)
- **Router-R1**: [Router-R1: LLM as Universal Router](https://arxiv.org/abs/2506.09033)
