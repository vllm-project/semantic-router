...
Hybrid selection combines multiple selection methods (Elo, RouterDC, AutoMix) with configurable weights for comprehensive model selection.

Based on the [Hybrid LLM paper](https://arxiv.org/abs/2404.14618) - Cost-Efficient Quality-Aware Query Routing.
