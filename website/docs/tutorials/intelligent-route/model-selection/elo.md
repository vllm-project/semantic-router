...
Elo Rating selection uses the classic Elo rating system (from chess) to rank models based on user feedback. Models that receive positive feedback gain rating points; those with negative feedback lose points.

Based on the [RouteLLM paper](https://arxiv.org/abs/2406.18665) (ICLR 2025).
