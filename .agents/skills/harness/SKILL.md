...
Use this skill whenever the current workspace is this repository or the task touches files under `src/`, `tools/agent/`, `dashboard/`, or `.github/`.

## Required Flow

1. Read [`AGENTS.md`](../../../AGENTS.md) first.
2. Read [`tools/agent/docs/README.md`](../../../tools/agent/docs/README.md) and the nearest local `AGENTS.md` for hotspot directories.
...
5. For maintainer issue, PR, or release work, use [`tools/agent/docs/maintainer-ops.md`](../../../tools/agent/docs/maintainer-ops.md) and generated local state under `.agent-harness/maintainer/`.
