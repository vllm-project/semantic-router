...
Usage:
    python candle-binding/scripts/generate_qwen3_reference.py
"""
...
def main():
    ...
    # Run from the project root: python candle-binding/scripts/generate_qwen3_reference.py
    ...
    if not model_path.exists():
        ...
        print("     python candle-binding/scripts/generate_qwen3_reference.py")
        sys.exit(1)
