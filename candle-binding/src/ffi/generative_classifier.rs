//! FFI bindings for Qwen3 Multi-LoRA Generative Classifier
//!
//! Exposes the Qwen3 multi-adapter system to Go via C ABI.
//!
//! This module provides a thread-safe interface for:
//! - Loading a base Qwen3 model
//! - Loading multiple LoRA adapters dynamically
//! - Classifying text with different adapters
//! - Managing adapter lifecycle

use crate::model_architectures::generative::Qwen3MultiLoRAClassifier;
