...
var currentBackendContract = BackendContract{
	Backend: NativeBackendCandle,
	Embedding: EmbeddingContract{
		SupportedFamilies:  []EmbeddingFamily{EmbeddingFamilyQwen3, EmbeddingFamilyGemma, EmbeddingFamilyMMBert},
		BatchedFamilies:    []EmbeddingFamily{EmbeddingFamilyQwen3},
		SupportsMultimodal: true,
	},
	UnifiedClassification: UnifiedClassificationContract{
		Supported:                  true,
		SupportsLoRABatchInference: true,
	},
	Lifecycle: LifecycleContract{
		SupportsBestEffortCleanup: true,
