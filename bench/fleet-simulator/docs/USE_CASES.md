# Fleet Simulation: Use Cases & Insights

`inference-fleet-sim` answers fleet-planning questions that cannot be resolved
...
for gpu in a10g a100 h100; do
  # homo baseline
  python3 run_sim.py optimize --cdf data/azure_cdf.json --lam 100 --slo 500 \
...
python3 run_sim.py compare-routers \
  --cdf data/agent_heavy_cdf.json --lam 20 --slo 1000 \
  --gpu-short h100 --gpu-long h100 \
...
python3 run_sim.py optimize --cdf data/azure_cdf.json  --lam 100 --slo 500 \
  --gpu-short a10g --gpu-long h100 --long-max-ctx  8192
python3 run_sim.py optimize --cdf data/lmsys_cdf.json --lam 100 --slo 500 \
  --gpu-short a10g --gpu-long h100 --long-max-ctx 65536
python3 run_sim.py optimize --cdf data/lmsys_cdf.json --lam 100 --slo 500 \
  --gpu-short a10g --gpu-long a100 --long-max-ctx 65536

# Puzzle 7: Disaggregated prefill/decode
python3 run_sim.py disagg --cdf data/azure_cdf.json --lam 100 \
...
python3 run_sim.py pareto --cdf data/lmsys_cdf.json       --lam 100 --slo 500 --long-max-ctx 65536
python3 run_sim.py pareto --cdf data/azure_cdf.json       --lam 200 --slo 500 --long-max-ctx  8192
python3 run_sim.py pareto --cdf data/agent_heavy_cdf.json --lam 200 --slo 500 --long-max-ctx 65536

# Puzzle 2: Agent SLO failure
python3 run_sim.py optimize --cdf data/agent_heavy_cdf.json --lam 20 --slo 1000 \
...
python3 run_sim.py whatif --cdf data/azure_cdf.json --slo 500 \
  --gpu-short h100 --gpu-long h100 --long-max-ctx 8192 \
  --lam-range 25 50 100 150 200 300 400

# Puzzle 5: Router comparison
python3 run_sim.py compare-routers --cdf data/azure_cdf.json --lam 200 --slo 500 \
  --gpu-short h100 --gpu-long h100 --n-s 5 --n-l 7 --long-max-ctx 8192 --n-req 5000
python3 run_sim.py compare-routers --cdf data/agent_heavy_cdf.json --lam 20 --slo 1000 \
...
python3 run_sim.py tok-per-watt --cdf data/azure_cdf.json --lam 100 --slo 500 \
  --gpus h100 a100 a10g --rho-sweep
python3 run_sim.py tok-per-watt --cdf data/lmsys_cdf.json --lam 100 --slo 500 \
  --gpus h100 a100
...
python3 run_sim.py grid-flex --cdf data/azure_cdf.json \
  --lam 200 --n-gpus 40 --gpu h100 --slo 500
python3 run_sim.py grid-flex --cdf data/azure_cdf.json \
