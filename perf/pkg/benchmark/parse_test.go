...
BenchmarkTrend/context_tokens=2048/learned_signals=4-8   	    3306	    456542 ns/op	   40404 B/op	     578 allocs/op
...
func TestParseBenchOutput(t *testing.T) {
	...
	if len(b.Benchmarks) != 5 {
		t.Fatalf("parsed %d benchmarks, want 5 (%v)", len(b.Benchmarks), b.Benchmarks)
	}
	...
	trendDimensions := b.Benchmarks["BenchmarkTrend/context_tokens=2048/learned_signals=4"].Dimensions
	if trendDimensions["context_tokens"] != "2048" || trendDimensions["learned_signals"] != "4" {
		t.Fatalf("trend dimensions = %v", trendDimensions)
	}
