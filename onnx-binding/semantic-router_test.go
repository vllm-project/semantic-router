...
func TestInitMmBertEmbeddingModel(t *testing.T) {
	...
	t.Run("InitWithValidPath", func(t *testing.T) {
		...
		if rustState, goState := IsModelInitialized(); !rustState || !goState {
			t.Fatal("Model should be initialized")
		}
	})

	t.Run("InitWithEmptyPath", func(t *testing.T) {
		// The native API rejects an empty path even after successful initialization.
...
func TestCalculateEmbeddingSimilarity(t *testing.T) {
	...
	t.Run("SimilarityWithDimensionTruncation", func(t *testing.T) {
		// Compare similarity calculations at different target dimensions
...
func TestCalculateSimilarityBatch(t *testing.T) {
	...
	t.Run("BatchWithDimensionTruncation", func(t *testing.T) {
