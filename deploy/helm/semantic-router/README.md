...
| env[1].name | string | `"HOME"` |  |
| env[1].value | string | `"/tmp"` |  |
| env[2].name | string | `"TMPDIR"` |  |
| env[2].value | string | `"/tmp"` |  |
| env[3].name | string | `"HF_HOME"` |  |
| env[3].value | string | `"/app/models/.cache/huggingface"` |  |
| env[4].name | string | `"HF_TOKEN"` |  |
...
| env[5].name | string | `"HUGGINGFACE_HUB_TOKEN"` |  |
| env[5].valueFrom.secretKeyRef.key | string | `"token"` |  |
| env[5].valueFrom.secretKeyRef.name | string | `"hf-token-secret"` |  |
| env[5].valueFrom.secretKeyRef.optional | bool | `true` |  |
| env[6].name | string | `"HF_ENDPOINT"` |  |
| env[6].value | string | `"https://huggingface.co"` |  |
