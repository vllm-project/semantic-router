...
type SessionAwareSelectionConfig struct {
	...
	ContextPortabilityWeight    float64 `yaml:"context_portability_weight,omitempty"`
	MinSwitchContextPortability float64 `yaml:"min_switch_context_portability,omitempty"`
	ProviderStatePenalty        float64 `yaml:"provider_state_penalty,omitempty"`
	ProviderStateHardLock       *bool   `yaml:"provider_state_hard_lock,omitempty"`
}
