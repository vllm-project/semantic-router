...
var maintainedFullConfigAssets = []string{
	...
	"e2e/config/config.authz-rbac-demo.yaml",
	"e2e/config/config.authz-rbac.yaml",
	"e2e/config/config.e2e.yaml",
	"e2e/config/config.hallucination.yaml",
	"e2e/config/config.image-gen.yaml",
	"e2e/config/config.memory-user.yaml",
	"e2e/config/config.modality-routing.yaml",
	"e2e/config/config.multi-endpoint.yaml",
	"e2e/config/config.multi-provider.yaml",
	"e2e/config/config.response-api-redis.yaml",
	"e2e/config/config.response-api.yaml",
	"e2e/config/config.testing.yaml",
	"e2e/config/onnx-binding/config.onnx-binding-test.yaml",
	"e2e/config/onnx-binding/config.onnx-classifiers-test.yaml",
...
var maintainedValuesConfigAssets = []string{
	...
	"e2e/profiles/aibrix/values.yaml",
	"e2e/profiles/authz-rbac/values.yaml",
	"e2e/profiles/dynamic-config/values.yaml",
	"e2e/profiles/llm-d/values.yaml",
	"e2e/profiles/ml-model-selection/values.yaml",
	"e2e/profiles/multi-endpoint/values.yaml",
	"e2e/profiles/production-stack/values.yaml",
	"e2e/profiles/rag-hybrid-search/values.yaml",
	"e2e/profiles/response-api-redis-cluster/values.yaml",
	"e2e/profiles/response-api-redis/values.yaml",
	...
	"e2e/profiles/streaming/values.yaml",
}
