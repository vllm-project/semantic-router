...
func TestHandleListMemories_Success(t *testing.T) {
	...
	req := newMemoryRequest(http.MethodGet, "/api/v1/storage/memories?user_id=user-alice", nil)
...
func TestHandleListMemories_FilterByType(t *testing.T) {
	...
	req := newMemoryRequest(http.MethodGet, "/api/v1/storage/memories?user_id=user-alice&type=semantic", nil)
	w := httptest.NewRecorder()
...
func TestHandleListMemories_FilterByMultipleTypes(t *testing.T) {
	...
	req := newMemoryRequest(http.MethodGet, "/api/v1/storage/memories?user_id=user-alice&type=semantic,episodic", nil)
	w := httptest.NewRecorder()
...
func TestHandleListMemories_Limit(t *testing.T) {
	...
	req := newMemoryRequest(http.MethodGet, "/api/v1/storage/memories?user_id=user-alice&limit=2", nil)
	w := httptest.NewRecorder()
...
func TestHandleListMemories_LimitValidation(t *testing.T) {
	...
	for _, limit := range []string{"abc", "0", "-1"} {
		req := newMemoryRequest(http.MethodGet, "/api/v1/storage/memories?user_id=user-alice&limit="+limit, nil)
		w := httptest.NewRecorder()
...
func TestHandleListMemories_LimitCapsAtMax(t *testing.T) {
	...
	req := newMemoryRequest(http.MethodGet, "/api/v1/storage/memories?user_id=user-alice&limit=1000", nil)
	w := httptest.NewRecorder()
...
func TestHandleListMemories_EmptyResult(t *testing.T) {
	...
	req := newMemoryRequest(http.MethodGet, "/api/v1/storage/memories?user_id=user-nobody", nil)
	w := httptest.NewRecorder()
...
func TestHandleListMemories_UserIsolation(t *testing.T) {
	...
	req := newMemoryRequest(http.MethodGet, "/api/v1/storage/memories?user_id=user-bob", nil)
	w := httptest.NewRecorder()
