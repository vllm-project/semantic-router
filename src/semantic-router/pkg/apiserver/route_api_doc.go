...
var endpointRegistry = []EndpointMetadata{
	...
	{Path: "/config/classifiers", Method: "GET", Description: "List configured taxonomy classifiers"},
	{Path: "/config/classifiers", Method: "POST", Description: "Create a managed taxonomy classifier"},
	{Path: "/config/classifiers/{name}", Method: "GET", Description: "Read a taxonomy classifier"},
	{Path: "/config/classifiers/{name}", Method: "PUT", Description: "Update a managed taxonomy classifier"},
	{Path: "/config/classifiers/{name}", Method: "DELETE", Description: "Delete a managed taxonomy classifier"},
