...
func TestSetupRoutesConfigEndpoints(t *testing.T) {
	...
	tests := []struct {
		...
		{method: http.MethodGet, path: "/api/v1/config", shouldExist: true},
		{method: http.MethodPatch, path: "/api/v1/config", shouldExist: true},
		{method: http.MethodPut, path: "/api/v1/config", shouldExist: true},
		{method: http.MethodPost, path: "/api/v1/config/validate", shouldExist: true},
		{method: http.MethodPost, path: "/api/v1/config/plan", shouldExist: true},
		{method: http.MethodPost, path: "/api/v1/config/rollback", shouldExist: true},
		{method: http.MethodGet, path: "/api/v1/config/versions", shouldExist: true},
		{method: http.MethodGet, path: "/api/v1/config/recipes", shouldExist: true},
		{method: http.MethodPost, path: "/api/v1/config/recipes/validate", shouldExist: true},
		{method: http.MethodGet, path: "/api/v1/config/recipes/managed", shouldExist: true},
		{method: http.MethodPut, path: "/api/v1/config/recipes/managed", shouldExist: true},
		{method: http.MethodDelete, path: "/api/v1/config/recipes/managed", shouldExist: true},
