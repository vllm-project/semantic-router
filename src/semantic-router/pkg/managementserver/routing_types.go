...
type ModelReadService interface {
...
type ModelMutationService interface {
...
type RecipeManagementService interface {
...
type EntrypointReadService interface {
...
type EntrypointMutationService interface {
...
type EntrypointResolutionService interface {
...
type EntrypointManagementService interface {
	EntrypointReadService
	EntrypointMutationService
	EntrypointResolutionService
}
...
type RoutingManagementService interface {
	...
	EntrypointManagementService
	RoutingManifestService
}
...
type RoutingCommandResults interface {
	...
	LookupManifestDiff(context.Context, string, string) (routingmanagement.ManifestDiff, error)
