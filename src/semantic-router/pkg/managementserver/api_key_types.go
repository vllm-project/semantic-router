...
type APIKeyReadService interface {
...
type APIKeyMutationService interface {
...
type APIKeyOwnershipService interface {
...
type APIKeyCredentialService interface {
...
type APIKeyManagementService interface {
	APIKeyReadService
	APIKeyMutationService
	APIKeyOwnershipService
