...
//go:generate go run ../../cmd/configschema --repository-root ../../../..
...
func GenerateFromSource(repositoryRoot string) ([]byte, error) {
	...
	schema := reflector.Reflect(&routerconfig.CanonicalConfigDocument{})
...
func GenerateTypeScriptContract(schemaDocument []byte) ([]byte, error) {
	...
	return []byte(`// Code generated by cmd/configschema; DO NOT EDIT.
import routerConfigSchema from './router-config-v0.3.schema.json'
