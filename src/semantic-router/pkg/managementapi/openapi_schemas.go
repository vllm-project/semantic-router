...
var (
	...
	openObjectSchema = JSONSchema{Type: "object", AdditionalProperties: boolPointer(true)}
)

var canonicalSchemaCatalog = map[string]JSONSchema{
...
func canonicalSchemas() map[string]JSONSchema {
	return mergeOpenAPIExtensionSchemas(cloneSchemas(canonicalSchemaCatalog))
}
