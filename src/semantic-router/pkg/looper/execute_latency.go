...
// implementation (base, ratings, fusion, confidence, remom, workflows), so
// wall-clock latency is captured consistently regardless of whether the
// underlying algorithm dispatches its model calls sequentially or
// concurrently (issue #2694).
