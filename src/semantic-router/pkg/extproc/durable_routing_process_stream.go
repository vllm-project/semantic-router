...
func durableRoutingRequestHeaders(request *ext_proc.ProcessingRequest) (*core.HeaderMap, error) {
	if request == nil || request.GetRequestHeaders() == nil || request.GetRequestHeaders().GetHeaders() == nil {
		return nil, errors.New("durable routing ExtProc stream must start with request headers")
	}
...
func durableRoutingInternalGeneration(headerMap *core.HeaderMap) (routingcontext.Generation, bool) {
...
func durableRoutingInternalAuthenticated(headerMap *core.HeaderMap) bool {
