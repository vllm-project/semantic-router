...
type RequestContext struct {
	...
	VSRLearningPolicy             *routerLearningPolicy                         // Primary Router Learning adaptation trace
	VSRLearningPolicies           map[routerLearningMethod]routerLearningPolicy // Method-keyed Router Learning adaptation traces
