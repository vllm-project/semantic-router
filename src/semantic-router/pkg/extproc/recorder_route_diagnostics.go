...
func buildReplayRouteDiagnostics(
	...
	diagnostics := &routerreplay.RouteDiagnostics{
		...
		EffectiveMaxOutputTokens:         cloneReplayValue(ctx.EffectiveMaxOutputTokens),
		EffectiveMaxOutputTokensSource:   ctx.EffectiveMaxOutputTokensSource,
		EffectiveMaxOutputTokensFallback: ctx.EffectiveMaxOutputTokensFallback,
	}
