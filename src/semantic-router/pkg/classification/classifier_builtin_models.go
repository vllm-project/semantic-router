...
func (c *Classifier) IsCategoryEnabled() bool {
	return c.Config.CategoryModel.Enabled && c.Config.CategoryModel.ModelID != "" && c.Config.CategoryMappingPath != "" && c.CategoryMapping != nil
}
...
func (c *Classifier) IsPIIEnabled() bool {
	return c.Config.PIIModel.Enabled && c.Config.PIIModel.ModelID != "" && c.Config.PIIMappingPath != "" && c.PIIMapping != nil
}
