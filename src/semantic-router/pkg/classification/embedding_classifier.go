...
type EmbeddingClassifier struct {
	...
	// Configuration
	optimizationConfig config.EmbeddingClassifierOptimization
	preloadEnabled     bool
	useHNSW            bool
}
...
func NewEmbeddingClassifier(cfgRules []config.EmbeddingRule, optConfig config.EmbeddingClassifierOptimization) (*EmbeddingClassifier, error) {
	// Apply defaults
