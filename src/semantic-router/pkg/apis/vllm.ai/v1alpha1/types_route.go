...
type DecisionPlugin struct {
	...
	// +kubebuilder:validation:Required
	// +kubebuilder:validation:Enum=context_compression;decision_diagnostics;fast_response;hallucination;header_mutation;memory;rag;request_params;response_jailbreak;router_replay;response_cache;response-cache;semantic_cache;semantic-cache;system_prompt;tools
	Type string `json:"type" yaml:"type"`
