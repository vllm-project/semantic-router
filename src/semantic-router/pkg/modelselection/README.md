...
├── selector_load_test.go        # Integration tests
└── data/
...
| 1028 | `category == "computer_science"` | 1.0 if CS, else 0.0 |
| 1029 | `category == "history"` | 1.0 if history, else 0.0 |
| 1030 | `category == "economics"` | 1.0 if economics, else 0.0 |
| 1031 | `category == "health"` | 1.0 if health, else 0.0 |
| 1032 | `category == "psychology"` | 1.0 if psychology, else 0.0 |
| 1033 | `category == "law"` | 1.0 if law, else 0.0 |
| 1034 | `category == "business"` | 1.0 if business, else 0.0 |
| 1035 | `category == "philosophy"` | 1.0 if philosophy, else 0.0 |
| 1036 | `category == "engineering"` | 1.0 if engineering, else 0.0 |
| 1037 | `category == "other"` | 1.0 if other/unknown, else 0.0 |
