...
// exactMemoryEntry is shared by the native and stub in-memory cache paths.
// Exact response caching does not require the native embedding implementation.
...
// AddExact stores a complete exact response without requiring native embedding.
