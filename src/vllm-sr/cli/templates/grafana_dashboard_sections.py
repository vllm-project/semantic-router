...
def append_routing_selection_section(ctx: DashboardBuildContext) -> None:
    ctx.panels.append(
...
def append_windowed_model_health_section(ctx: DashboardBuildContext) -> None:
    ctx.panels.append(
...
def append_session_cache_warmth_section(ctx: DashboardBuildContext) -> None:
    ctx.panels.append(
