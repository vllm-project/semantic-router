...
- Treat `models.py`, `config_import.py`, and `validator.py` as config-contract hotspots whose ownership should stay split between schema, explicit external import, and semantic validation.
