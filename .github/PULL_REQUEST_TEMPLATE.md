...
- [ ] If the desired architecture still diverges from the implementation after this PR, add or update the relevant item in `docs/agent/tech-debt-register.md` and its indexed entry under `docs/agent/tech-debt/`.
