...
- For durable unresolved code/spec mismatches, verify the gap is promoted to `docs/agent/tech-debt-register.md` and its indexed entry under `docs/agent/tech-debt/`.
